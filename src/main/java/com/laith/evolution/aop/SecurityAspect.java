...
public class SecurityAspect {
    ...
    @Pointcut("@annotation(com.laith.evolution.annotations.RateLimit)")
    private void rateLimitAnnotation() {}

    @Pointcut("@annotation(com.laith.evolution.annotations.BlacklistCheck)")
    private void blacklistAnnotation() {}


    @Around("rateLimitAnnotation() || blacklistAnnotation()")
    public Object handleSecurity(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        RateLimit rateLimit = getAnnotation(joinPoint, RateLimit.class);
        BlacklistCheck blacklistCheck = getAnnotation(joinPoint, BlacklistCheck.class);
    ...
    private void checkAuthentication() {
        ...
        log.info("User already authenticated: " + auth.getName());
    }
    ...
    private <T extends java.lang.annotation.Annotation> T
        getAnnotation(ProceedingJoinPoint joinPoint, Class<T> annotationClass) {
